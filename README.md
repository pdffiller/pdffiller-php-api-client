...
If you want upload file to PDFfiller, you must to create a new Uploader object with the needed information and upload it using `PDFfiller\OAuth2\Client\Provider\Uploader::upload()` method
````php
...
````
If you need to fill your template, you need to create new FillableTemplate object pass values for fields and save using method `PDFfiller\OAuth2\Client\Provider\FillableTemplate::save()`
````php
...
If you want to create LinkToFill from some document, you must create new FillRequest object with needed information and save it using method `PDFfiller\OAuth2\Client\Provider\FillRequest::save()`
````php
...
If you want to create SendToSign from some document, you must create new SignatureRequest object with needed information and save it using method `PDFfiller\OAuth2\Client\Provider\SignatureRequest::save()`
````php
